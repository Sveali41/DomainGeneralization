...
from modelBased.gen.gen import GAN

def load_gen(cfg):
    hparams = cfg
    if hparams.training_generator.generator == "deconv":
        import sys
        sys.path.append('/home/siyao/project/rlPractice/DomainGeneralization/modelBased/gen')
        from modelBased.gen.deconv_gen import Generator, Discriminator
        ...
        from modelBased.gen.basic_gen import Generator, Discriminator
